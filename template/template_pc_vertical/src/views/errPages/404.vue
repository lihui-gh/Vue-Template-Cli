<template>
  <div style="background:#f0f2f5;margin-top: -20px;height:100%;">
    <div class="wscn-http404">
      ...
      <div class="bullshit">
        <div class="bullshit__oops">您的权限不足!</div>
        <div class="bullshit__headline">{{ message }}</div>
        <div style="margin-top: 50px" class="bullshit__info">请检查您输入的网址是否正确，请点击以下按钮返回主页</div>
        <a href="/" style="margin-left: 40px" class="bullshit__return-home">返回首页</a>
      </div>
    </div>
  </div>
</template>
